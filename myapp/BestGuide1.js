          ...
          {this.state.origin ? (
            ...
            >
              <View style={{ flexDirection: "row", backgroundColor: "white" }}>
                <Text style={styles.text}>目的地經度：</Text>

                <TextInput
                  style={{ height: 30, width: 90, color: "black" }}
                  placeholder="請輸入..."
                  ...
                  value={this.state.ori_lat}
                />

                <Text style={styles.text}>目的地緯度：</Text>
